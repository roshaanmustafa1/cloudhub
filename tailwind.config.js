...
module.exports = {
  darkMode: ['class'], safelist: ['dark'], prefix: '',
  ...
  theme: {
    container: {
      ...
      fontFamily: {
        ...
        'gradient-primary': 'linear-gradient(315deg, #FF240E 0%, #FF4600 100%)'
      }, colors: {
        ...
        orange: {
          DEFAULT: 'hsl(var(--orange))', foreground: 'hsl(var(--orange-foreground))'
        },
        secondary: {
